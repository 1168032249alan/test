...
int main()
{
    ...
    while(seguir=='s')
    {
        ...
        printf("15- Listado  de propietarios  \n ");
        printf("18- Salir\n");
        ...
        switch(opcion)
        {
            ...
            case 14:
                ...
                break;
            case 15:
                ePropietario_mostrarListadoAscendente(listaPropietarios,CANTIDADPROPIETARIOS);
                break;
            case 16:
                seguir = 'n';
                break;
            default:
                printf("Error, ingrese un numero del 1 al 16.\n");
                break;
        }
    }
    return 0;
